    ...
    <x-slot name="header">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Kelola dan pantau semua order pool di platform TaniDirect.
            </p>
        </div>
    </x-slot>
                        ...
                        >
                            ...
                            <div class="p-6">
                                ...
                                <div class="mt-6">
                                    ...
                                    <a
                                        href="{{ route('admin.order-pools.show', $orderPool) }}"
            ...
            @else
                ...
                <div class="rounded-2xl bg-white py-16 text-center shadow-sm dark:bg-gray-800">
                    ...
                    <p class="mt-2 text-gray-500">
                        Order pool akan muncul di sini ketika pembeli membuat order pool.
                    </p>
